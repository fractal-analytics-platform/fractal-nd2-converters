...
DATA_EXTENDED_DIR = Path(__file__).parent / "data-extended" / "Nikon-ND2"
...
def _generate_snapshot(
    *,
    ...
    # Derive plate names from image_list_updates (avoids stale zarrs from overwrites)
    plate_names = sorted(
        {
    ...
    *,
    ...
    Args:
        ...
        output_type: "plate" for HCS plate output, "single_image" for
            individual zarr containers at the top level of zarr_dir.
    """
    if update_snapshots:
