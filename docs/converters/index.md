...
|---|---|---|---|
| `Path` | `str` | *required* | Path to a `.nd2` file or a folder of `.nd2` files. |
...
Each converter adds a few task-specific fields on top of these — see the [ND2 Plate](nd2_plate.md) and [ND2 Image](nd2_image.md) guides.
...
- [ND2 Plate](nd2_plate.md)
- [ND2 Image](nd2_image.md)
