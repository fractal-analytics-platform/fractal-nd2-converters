"""Python API for the Nikon ND2 plate converter."""
...
from fractal_nd2_converters.common import image_in_plate_compute_task
...
def convert_nd2_plate(
    *,
    ...
    """Convert a Nikon ND2 plate dataset to OME-Zarr.
    ...
    return exec_compound_task(
        init_task_fn=convert_nd2_plate_init_task,
