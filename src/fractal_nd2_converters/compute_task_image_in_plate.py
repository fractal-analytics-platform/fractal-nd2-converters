"""Compute task for plate-based ND2 acquisitions."""
...
@validate_call
def compute_task_image_in_plate(
    *,
    # Fractal parameters
    zarr_url: str,
    init_args: ConvertParallelInitArgs,
) -> ImageListUpdateDict:
    """Create a single OME-Zarr image in an OME-Zarr plate.
...
if __name__ == "__main__":
    ...
    run_fractal_task(task_function=compute_task_image_in_plate, logger_name=logger.name)
